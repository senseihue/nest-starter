export const BPMN_CONTROLLER_TAG = 'bpmn';
export const BPMN_CONTROLLER_BASE_PATH = 'bpmn';

export const BPMN_ROUTES = {
...
export const BPMN_OPERATION_SUMMARIES = {
...
export const BPMN_OPERATION_DESCRIPTIONS = {
...
export const BPMN_RESPONSE_DESCRIPTIONS = {
...
export const BPMN_DEFINITION_CONSTANTS = {
...
export const BPMN_RESPONSE_CONSTANTS = {
  FORMAT: 'bpmn-xml',
  FILE_EXTENSION: '.bpmn',
