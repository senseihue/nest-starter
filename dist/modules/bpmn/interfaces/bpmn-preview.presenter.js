...
exports.toBpmnPreviewHtml = toBpmnPreviewHtml;
const bpmn_constants_1 = require("../bpmn.constants");
function toBpmnPreviewHtml() {
    const basePath = `/api/${bpmn_constants_1.BPMN_CONTROLLER_BASE_PATH}`;
    const exportUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.EXPORT_XML}`;
    const importUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.IMPORT_XML}`;
    const roundtripUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.ROUNDTRIP_XML}`;
    const downloadUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.DOWNLOAD_XML}`;
    const previewUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.PREVIEW}`;
    const viewerJsUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.ASSET_VIEWER_JS}`;
    const diagramCssUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.ASSET_DIAGRAM_CSS}`;
    const bpmnCssUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.ASSET_BPMN_CSS}`;
    const bpmnFontCssUrl = `${basePath}/${bpmn_constants_1.BPMN_ROUTES.ASSET_BPMN_FONT_CSS}`;
...
//# sourceMappingURL=bpmn-preview.presenter.js.map