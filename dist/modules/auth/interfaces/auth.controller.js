...
__decorate([
    ...
    (0, log_decorator_1.Loggable)('Auth register'),
    (0, swagger_1.ApiOperation)({ summary: 'Register user', description: 'Creates user with password' }),
    (0, swagger_1.ApiOkResponse)({ description: 'Registered user' }),
...
__decorate([
    ...
    (0, log_decorator_1.Loggable)('Auth login'),
    (0, swagger_1.ApiOperation)({ summary: 'Login', description: 'Returns JWT access token' }),
